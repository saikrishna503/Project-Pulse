...
export const getCSEProjects = async (token) => {
    return await axios.get(`${BASE_URL}/csea`, {
      headers: { Authorization: `Bearer ${token}` }
    });
  };
  
  export const getCSDProjects = async (token) => {
    return await axios.get(`${BASE_URL}/csda`, {
      headers: { Authorization: `Bearer ${token}` }
    });
  };
  
  export const getCSMProjects = async (token) => {
    return await axios.get(`${BASE_URL}/csma`, {
      headers: { Authorization: `Bearer ${token}` }
    });
  };
