...
const CSM = () => {
  ...
  return (
    <DepartmentWrapper id="csm">
      <Title>Computer Science and Engineering (Artificial Intelligence)</Title>
      <Description>Explore the various specializations within our Computer Science and Engineering (Artificial Intelligence) department.</Description>
      <DepartmentContainer>
